...
/* Defer to the system regex library about the meaning
        ...
        for (c = 0; c < 1 << 8; ++c) {
          ...
          subject[0] = c;
          if (rpl_regexec((&re),subject,0,((void *)0),0) != 0) {
...
#endif
{
      ...
      visited[old . index] = 1;
      if(d -> tokens[old . index] == BEGLINE)//{
//        case BEGLINE:
{
          p . constraint &= 0x444;
//          break; 
        }
    else  if(d -> tokens[old . index] == ENDLINE)
{
          p . constraint &= 0x700;
//          break; 
        }
      else  if(d -> tokens[old . index] == BEGWORD)
{
          p . constraint &= 0x050;
//          break; 
        }
      else  if(d -> tokens[old . index] == ENDWORD)
{
          p . constraint &= 0x202;
//          break; 
        }
      else  if(d -> tokens[old . index] == LIMWORD)
{
          p . constraint &= 0x252;
//          break; 
        }
      else  if(d -> tokens[old . index] == NOTLIMWORD)
{
          p . constraint &= 0x525;
//          break; 
        }
